...
try {
    ...
    $code = property_exists($e, 'http_code') ? $e->http_code : 400;
...
try {
    ...
    $ins = $conn->prepare('INSERT INTO positions_status (status_name, status_color, pool_id, active, sort_order) VALUES (?, ?, ?, ?, ?)');
    ...
    $tstmt = $conn->prepare('INSERT INTO positions_status_transitions (from_status_id, to_status_id, active, updated_by, updated_at) VALUES (?, ?, 1, ?, NOW())');
